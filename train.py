...
import shutil
shutil.copy2('random2.joblib','/result/Mua_Mua_CnCAbnormalDetect2_'+str(accuracy_in_name)+'.joblib')

RF2 = load('/result/Mua_Mua_CnCAbnormalDetect2_'+str(accuracy_in_name)+'.joblib')     
...
print(result2)
print("Success")
check_file = os.path.isfile('/result/Mua_Mua_CnCAbnormalDetect2_'+str(accuracy_in_name)+'.joblib')
print(check_file)
